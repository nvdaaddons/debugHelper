# -*- coding: utf-8 -*-
# Log Helper (logHelper.py), version 0.3-dev1
...
class GlobalPlugin (globalPluginHandler.GlobalPlugin):
	...
	def script_logAMarkLine(self, gesture):
		...
		message = "{0}{1}{2}".format("\n" * self.newlinesBefore, self.markString.format(logHelper_markNumber), "\n" * self.newlinesAfter)
		ui.message("Logging mark {0}!".format(logHelper_markNumber))
		log.info(message)
